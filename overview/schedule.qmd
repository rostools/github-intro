...
The general schedule outline is shown in the below table. Note that this is
...
| 25 | {{< fa person-chalkboard >}} [The basics of Git and GitHub](/sessions/basics.qmd) |
| 20 | {{< fa laptop-code >}} [Creating a repository on GitHub](/sessions/create-repo.qmd) |
