# Is it for you? {#sec-is-it-for-you}
...
-   You are able to work on files---and are comfortable enough doing
    so---while only using a web browser interface (like GitHub's interface).
...
In addition to the assumptions above, the workshop also have a fairly
