...
-   You are able to work on file--and are comfortable enough doing so--only
    using a web browser interface (like GitHub's interface).
...
In addition to the assumptions above, the workshop also have a fairly focused scope, which may also help you decide
