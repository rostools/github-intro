...
on various aspects. These needs include, in in no particular order,
being able to:

1.  Formally disseminate more types of new or existing knowledge and
    scientific output
2.  Informally share information, discussions, or ideas more frequently
    and more rapidly
...
are now so great that we must embrace new tools to effectively fulfil
those needs.
...
Broken down into specific objectives, the workshop is designed to enable
you to:
