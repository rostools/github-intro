...
in this section and finish with **completing the survey** in [section
@sec-pre-workshop-survey] at the end. These tasks are designed to make
it easier for everyone to start the workshop with everything set up and
