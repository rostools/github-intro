...
in this section and finish with **completing the survey** at the end
(@sec-pre-workshop-survey). These tasks are designed to make it easier
for everyone to start the workshop with everything set up.
