...
[GitHub](https://github.com/)---a website that hosts Git reposities and builds on Git's core features. This means that your Git
...
and folders) will happen through the GitHub website. Behind the scenes, GitHub will use Git to track the changes we make.
...
While we will only be interacting with Git on GitHub during this workshop,
...
newer. Git and GitHub, on the other hand, use a more complex way of handling
conflicts by showing you the changes and allowing you to resolve them as you want to.
