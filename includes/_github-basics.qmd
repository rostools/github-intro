...
and asking you to resolve them. We won't cover conflicts in this
workshop since conflicts usually (but not always) happen when you are
working with several other people on a repository. But this workshop
isn't about working with others, only how you can use GitHub on your
own.
...
files together, not just sharing them. But again, we won't cover
collaborating with others in this workshop, that will be for another
workshop.
:::
