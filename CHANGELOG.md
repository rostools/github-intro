...
"releases" of the workshop based on the commit messages.
Releases in the context of workshops are simply snapshots in time of the
workshop content that we publish to Zenodo for easier
...
Because a new release is created based on the commit message,
...
- :pencil2: use single quotes within fig alt text (#317)
...
- :pencil2: casing "Github" -> "GitHub (#283)
...
- :memo: add download image to teacher pre-workshop tasks (#268)

### Fix

- :memo: update issues learning objs after discussion activity was removed (#267)
...
- :recycle: updates from `template-workshop` (#252)

## 0.5.5 (2025-09-03)

### Refactor

- **sessions**: :recycle: split into basics and create repo sessions (#248)
...
- **pre-workshop**: :sparkles: add footnote explaining that links are not required (#246)
