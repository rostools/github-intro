...
1.  During the first session, [The Basics of Git and
    ...
    and GitHub, including how to create a repository and navigate
    GitHub. This will be a more theoretical session, where we will learn
    about the concepts of Git and GitHub, including what a repository
    is, how to navigate GitHub, and how to use Git to track changes to
    files. We will also learn about the difference between Git and
    GitHub, and how they work together.

2.  Then, in the more practical second session, [Working with files on
