...
## :book: Reading task: Workshop details

**Time: \~8 minutes.**

### Learning design {.unnumbered}

<!-- TODO: Move this over into an include for other websites? -->
...
learning" by engaging with the material, practice retrieving what was
just taught, repeatedly be exposed to and retrieve the content, linking
the new information with what you already know, and explaining it to
someone else.
...
-   Having a clear learning goal with a strong narrative throughout the
...
-   The main activities are "code-alongs", where the teacher types on
    the computer and explains what it means while the learner types
    along. The connection between using the hands and doing something
    tangible helps reinforce learning. It also helps the teachers to go
    slower since we have to both explain and type things out, which
    helps you learn better. The phrase "less is more" applies strongly
    to learning.

-   We include several hands-on, practical exercises that reinforce what
    was just taught through retrieval practice and repetition. It gives
    you a chance to engage with the material and the space to try it out
    on your own so that your brain makes the connections.

-   We have discussion activities to encourage linking the new
    information with what you already know or do in your work and how
    ...
    something to someone else is also one of the best ways to learn! The
    quote "while we teach, we learn" is true here.

-   Reading content is a much better way to consume information than
    listening to someone talk. This is also why we have minimal to no
    slides or lectures, as they are forms of information sharing with
    the lowest rates of learning. You can re-read things you may not
    understand, go at your pace, and take notes, all of which support
    learning. We have several reading tasks throughout the workshop. To
    help reinforce what you just read, the teacher will briefly
    summarise and emphasise key points after you've read it, which is
    another form of repetition and targets another part of the brain
...
-   Our brains can get easily distracted, which is completely normal! So
    ...
    make sure to follow the material exactly, so that it is much easier
...
Now you're aware enough on how we've designed this workshop to really
support and enable your learning! :tada: :grin:

### Other details {.unnumbered}

Aside from the learning design of the workshop, these are some
additional details for the workshop:

-   The schedule listed in @sec-schedule is a *guide* only, some
...
-   We seek out and use feedback to improve the workshops. At the end of
    ...
    improve on and you help us identify those things.
