...
just taught, repeatedly being exposed to and retrieve the content, linking
...
-   The main activities are "code-alongs", where the teacher types on
    the computer and explains what it means while you type
...
-   We include several hands-on exercises that reinforce what
    ...
    on your own, so you start to get a real sense of how to do it yourself.
...
-   We have minimal to no
    slides or lectures, as they are forms of information sharing with
    the lowest rates of learning. Instead we include reading tasks, so
    you can re-read things you may not
...
-   Our brains can get easily distracted, which is completely normal! So
    ...
    make sure to follow the material on the website closely, so that it is easier
...
Now you know a bit more about the thoughts behind how we've designed this workshop to really try to
