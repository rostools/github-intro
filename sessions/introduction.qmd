...
Start of the workshop by introducing yourself and the helpers. Then
briefly introduce to the workshop by going through the
...
tasks](/pre-workshop/git-and-github.qmd), Git repositories comes with a
