...
Start of the workshop by introducing yourself and the helpers. Then briefly introduce to the workshop by going through the [schedule](/overview/schedule.qmd).
:::
...
workshop. This will help you understand how the workshop is designed and
what to expect:
...
-   We use "stickies" to assess how everyone is doing and for you to
    request help if you get stuck. When the "help" sticky is up, a
...
When you're learning something new, it helps to put it into a context. While we've already covered some of this in the
...
managing Git repositories. And, as we saw in the [pre-workshop tasks](/pre-workshop/git-and-github.qmd), Git repositories comes with a lot of
features to work with files and track changes to
them. But GitHub does much more than that. It
can be used for [project
management](https://docs.github.com/en/issues/planning-and-tracking-with-projects/learning-about-projects/about-projects), running automatic [workflows](https://docs.github.com/en/actions) that do
tasks for you, hosting [websites](https://docs.github.com/en/pages), and [collaborating](https://docs.github.com/en/get-started/using-github/github-flow)
with others, for example by reviewing each others work.
...
researchers to discover your work and research. It is a great way to share your research and make it more [open and accessible](https://en.wikipedia.org/wiki/Open_research). 
...
to using GitHub to manage your files related to your research and work. Before diving into some of the more advanced uses, it’s important to understand the basics of how GitHub works and how to use it effectively. In this workshop, our focus is to cover the most fundamental and
important features of GitHub that will help you get started with using it for your own work.
