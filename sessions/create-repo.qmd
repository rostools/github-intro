...
the page. After you click the button, you'll be taken to the landing page
...
After creating a new repository, we're taken to the repository's landing
...
-   Create a new repository by clicking the **Create new...** button
    ...
    navigation bar.
-   A repository's landing page shows all the files and folders in the
