...
the issue, we can see more details, such as comments, and we can also close
...
If you want to see an overview of the issues in a specific
...
clicking the inbox button in the top right corner on GitHub ({{< var inbox-icon >}})  and click on the
issue to see the details.
