...
5.  When you have written your comment, click the green "Comment" button
    to post the comment.
6.  When both you and your neighbour have added a comment to each
    other's issues, see if you can find the comment in your
    notifications inbox (the inbox icon {{< var inbox-icon >}} in the
    top navigation bar). You can also go to your repository by clicking
    on your user icon in the top right corner on GitHub and selecting
    "Your repositories" from the dropdown menu. This will take you to a
    list of all your repositories, where you can find your repository
    and go to the issue from there.
7.  Let’s say you decide to follow your neighbor’s suggestion. Add a
    comment to say so, then click “Close issue” to mark it as completed.
    This will remove the issue from the list of open issues in the
    repository. You can always come back to it later by going to the
    "Issues" tab and removing the "state:open" part in the search bar.
...
## :technologist: Exercise: Add new issue with reference to the closed issue

**Time: \~Minutes minutes.**

Another nice feature of GitHub Issues is that you can reference other
issues in your issues. This is useful if you want to keep track of
related issues or tasks. For example, now that you have decided to
follow your neighbour's suggestion about what recipe to add next, you
can create an issue reminding you to add what your neighbour suggested.

1.  In your repository, click the "Issues" tab, and then the "New issue"
    button.
2.  Fill in the title with text like "Add brownie recipe" (or whatever
    recipe your neighbour suggested).
3.  Then fill in the description box with the recipe you want to add.
    Add a link to the issue you closed earlier by typing `#` followed by
    the issue number. For example, if the issue number was 1, you would
    type `#1`. This will create a link to the issue in your new issue.
    When you type out `#`, GitHub will show you a list of things in the
    repository that you can link to. You can select the issue you want
    to link to from the dropdown menu.
...
-   Started collaborating a bit by commenting on someone else's issue to
    suggest a recipe.
-   Linked issues to each other to keep track of related tasks.
-   Discussed how we can use issues in our own work.
