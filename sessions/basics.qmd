...
In this new repository is only one file: `README.md`. The `README.md`
file is a common file included in repositories as it describes what the
repository contains and is used for.
