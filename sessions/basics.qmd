...
to what Git does before moving onto the practical parts of this
workshop. By including this repetition we aim to reinforce these new
concepts.
:::
...
forms the Git history. The message beside each commit is the commit
