...
Because the Git history consists of these connected commits that each have the
changes, we're able to see exactly what was changed. You can even go back to the state of the
