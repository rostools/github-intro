...
Once we've made the changes, let's commit them. Click the "Commit changes" 
button on the top-right of the page. Then when the message box pops up, 
write in the commit message "clarify the ingredients are for tomato soup".
Then click the "Commit changes" button on the bottom of the pop-up so that
the changes get saved to the history.
...
Now click the "Commit changes" button on the top-right side of the page to 
open the commit message pop-up. In the commit message section, type out a
message like: "move file into soups folder". Then click the "Commit changes"
button on the bottom of the pop-up.
