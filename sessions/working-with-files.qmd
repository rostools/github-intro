...
You will now explore history of your repository to find the commit where
you first added the cookie recipe.

1.  In the "Code" tab of your repository, click the "Commits" button on
    the top-right side of the page. This will show you all the changes
    that have been made to your repository along with the commit
    messages, the author of the changes, and when the changes where
    made. Neat!
2.  Go through the list of commits to find the commit where you added
    ...
    Click it to see what was changed in that commit. Take a moment to
    explore the information that GitHub provides about the commit.
