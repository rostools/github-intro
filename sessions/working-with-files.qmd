...
![](../images/icon-pencil.svg){fig-alt="Pencil icon"} on the top-right
...
the pencil icon ![](../images/icon-pencil.svg){fig-alt="Pencil icon"} on
...
1.  Click the pencil icon
    ![](../images/icon-pencil.svg){fig-alt="Pencil icon"} on the
...
1.  Click the pencil icon
    ![](../images/icon-pencil.svg){fig-alt="Pencil icon"} on top-right
