...
Now, let's upload a file to your repository. You can either upload a
random file from your compyter (a file that you don't mind sharing!) or
you can download our
[icon](https://raw.githubusercontent.com/rostools/github-intro/refs/heads/main/_extensions/rostools/r3-theme/favicon.ico)
and upload that to your repository. Alternatively, you can find an image
of a cookie or recipe book from a website like
[Pixabay](https://pixabay.com/) and upload that to your repository.
...
file in the repository and clicking the pencil icon
{{< var pencil-icon >}} on the top-right side of the page. Then, you can
change the file path to the folder you want to move it to as we did
previously with the recipe files.
:::
