...
-   **Use hyphens or underscores**: If you need to separate words in a
    ...
    introduce different issues in some situations and contexts. For example, different operating systems (Windows, Mac, Linux, etc.) handle spaces differently, so transferring files with spaces in their names between systems can lead to issues.  So, it’s best to avoid them altogether. 
