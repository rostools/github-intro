# Create and manage a GitHub account {#sec-github-account}

To participate in the workshop, you will need a GitHub account.

## Create your GitHub account

Please go to the [GitHub website](https://github.com/signup) and create an account. Remember (and/or write down)
...
you will receive a notification. By default, the notification are sent to
...
You can manage your notifications by setting a few options. While logged into your new GitHub account,
follow these steps:
...
not by email. But don't worry, you can still view all your
