...
1.  If you haven't already, go through the workshop overview section,
    including the [Syllabus](/overview/syllabus.qmd), [Is this for
    you?](/overview/is-it-for-you.qmd), and [Learning
    design](/overview/learning-design.qmd) to get an overview of what
    this workshop contains and the learning design behind the workshop
    material.
2.  Go through the the pre-workshop tasks to help build a shared
    foundation to build on when the workshop starts. This includes
    reading the [Code of conduct](/pre-workshop/code-of-conduct.qmd) and
    [Introduction to version control, Git and
    GitHub](/pre-workshop/git-and-github.qmd), as well as creating a
    [GitHub user account](/pre-workshop/github-account.qmd). Remember to
    finish the pre-workshop [survey](/pre-workshop/pre-survey.qmd) at
    the end. You will be taken through the pre-workshop tasks in order
    by clicking the arrow at the bottom of each page.
